...
global Ts;
Ts = 0.1;
xo = [0 0 0]'; % posição inicial

disp('Escolha a trajetória de acordo com as opções abaixo: '); 
traj = input('  1 - circular \n  2 - oito\n  3 - em L\n  4 - Quadrado\n  5 - Senóide\n\n Digite o valor correspondente à trajetória desejada: ');
...
m = input('Digite o número de voltas/períodos desejadas: '); %number of laps
...
elseif traj == 5 %senoidal
    ...
    L = input('Entre o comprimento máximo: ');
    b = m*(2.0*pi/L);
    k = round(L/(w*Ts))+1;
end
